...
// void ds1307_rtc_stop(uint8_t run){
...
int main(void){
	...
	//buzzer
	uint8_t buzzer = 0;
	TCCR1B = (1 << CS11) | (1 << CS10);		//prescaler 64 - time 
	TCCR0B = (1 << CS01) | (1 << CS00);		//prescaler 64 - frequency 
